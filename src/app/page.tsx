...
const CATEGORIES = [
  { key: "union" as const, label: "노조", icon: "👥", borderColor: "border-blue-200", headerBg: "bg-blue-50 text-blue-800" },
  { key: "employer" as const, label: "사용자", icon: "🏭", borderColor: "border-green-200", headerBg: "bg-green-50 text-green-800" },
  { key: "government" as const, label: "정부", icon: "🏛️", borderColor: "border-amber-200", headerBg: "bg-amber-50 text-amber-800" },
  { key: "court" as const, label: "법원", icon: "⚖️", borderColor: "border-red-200", headerBg: "bg-red-50 text-red-800" },
];
...
function MessageBubble({ msg }: { msg: Message }) {
  ...
  return (
    <div className="flex justify-start">
      <div className="bg-white border border-gray-200 rounded-2xl rounded-bl-md px-4 py-3 max-w-lg text-sm leading-relaxed shadow-sm">
        {msg.isLoading ? (
      ...
      <header className="w-full max-w-2xl px-4 pt-6 pb-3">
        <div className="bg-white border border-gray-200 rounded-2xl px-5 py-4 flex items-center gap-3 shadow-sm">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">노조 · 사용자 · 정부 · 법원 — 매일 아침 노동뉴스 브리핑</p>
          </div>
